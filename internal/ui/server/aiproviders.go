...
type providerView struct {
	...
	Problem   connect.Health `json:"problem"`
...
func (s *Server) handleProviderTest(w http.ResponseWriter, r *http.Request) {
	...
	prompt := prompts.Prompt(prompts.Input{Reason: "a connection test from the dashboard; answer as you would in a match", Role: dota.Mid, Snapshot: snap})
