...
type fakeData struct {
	...
	skills *opendota.SkillBuild
}

func (f fakeData) Items() map[string]opendota.ItemInfo { return f.items }
func (f fakeData) Hero(id int) (opendota.HeroInfo, bool) {
	return opendota.HeroInfo{ID: id, LocalizedName: "Anti-Mage"}, true
}
func (f fakeData) BuildFor(int, string) *opendota.Build           { return f.build }
func (f fakeData) SkillBuildFor(int, string) *opendota.SkillBuild { return f.skills }
