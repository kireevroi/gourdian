	...
	in := Input{
		...
		Snapshot: coach.Snapshot{
			...
			Build: []coach.BuildView{
				{BuildItem: dotadata.BuildItem{DName: "Wraith Band"}, Skipped: true},
				{BuildItem: dotadata.BuildItem{DName: "Battle Fury"}, Remaining: 1250, Next: true},
			},
...
func TestReviewPromptWithParsedReplay(t *testing.T) {
	detail := &matchdata.Detail{
		PlayerDetail: dotadata.PlayerDetail{Parsed: true, NetWorth: 14200, NetWorthRank: 2, HeroDamage: 21000, ObsPlaced: 3,
