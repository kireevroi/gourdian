...
const SHELL = ['/', '/app.css', '/js/api.js', '/js/app.js', '/js/index.js', '/js/events-worker.js',
  '/stats.html', '/js/stats.js', '/rules.html', '/js/rules.js', '/hud.html', '/js/hud.js',
  '/ai.html', '/js/ai.js', '/settings.html', '/js/settings.js', '/icon.svg', '/fonts/RussoOne-Regular.ttf'];
