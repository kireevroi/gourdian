...
Start from templates (Save for BKB, use Magic Wand when low, low mana, Lotus pool, shop while dead, buy Aghanim's Shard, ultimate is up, idle in base), duplicate rules, and export or import them as JSON.
